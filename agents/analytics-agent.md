...
này PHẢI chèn snippet này ngay sau `<title>` — xem chi tiết CLAUDE.md mục Hard Rules.
...
lượng thật gần nhất cho traffic giai đoạn chưa gắn tag. Lưu ý: nếu link nằm trong **comment**
(né LinkedIn giảm reach vì post có external link) thì chỉ số "Link engagements" của LinkedIn
**không đo được click đó** — 0 không có nghĩa là không ai bấm.
