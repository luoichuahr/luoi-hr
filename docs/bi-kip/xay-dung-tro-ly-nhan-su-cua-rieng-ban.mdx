...
- [Thiết kế hệ điều hành Claude dành riêng cho nhân sự](./thiet-ke-he-dieu-hanh-lam-viec-voi-claude-danh-rieng-cho-nguoi-lam-nhan-su) — Setup Projects + Global Instructions đúng cách trước khi xây agent
- [CV Extract Tool — Tự động đọc CV bằng AI](./cv_extract_tool) — Tool thực tế bạn có thể dùng ngay trong quy trình tuyển dụng
